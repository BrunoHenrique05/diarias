...
<body>
	...
	<ul>
		...
		<li><a class="active" href="formDiaria.html">Formulário de Solicitação de Diárias</a></li>
		<li><a href="aprovaçoes.html">Aprovação</a></li>
	...
	<form method="POST" action="processa_cad_viagens.php">
		...
		<br><br>
			...
			<div class="form-group"><br>
				...
				<i><textarea name="justificativa" class="form-control" id="justificativa" rows="6" style="border-radius: 10px;">JUSTIFICATIVA PELO ENCAMINHAMENTO DO PEDIDO COM MENOS DE 10 				DIAS DE ANTECEDÊNCIA DO DESLOCAMENTO (INCISOS I E IX, ART. 2º - PORT. MPOG Nº 98/03 / FERIADO OU FINAL DE SEMANA - § 2º, ART. 5º - DECRETO Nº 5.992/06)"></textarea> </i>
			</div>
